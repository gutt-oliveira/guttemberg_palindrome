...
require_relative "lib/guttemberg_palindrome/version"

Gem::Specification.new do |spec|
  spec.name = "guttemberg_palindrome"
  spec.version = GuttembergPalindrome::VERSION
  spec.authors = ["gutt-oliveira"]
  spec.email = ["guttemberg12@gmail.com"]

  spec.summary = "Palindrome detector"
  spec.description = "Learn Enough Ruby palindrome detector"
  spec.homepage = "https://github.com/gutt-oliveira/guttemberg_palindrome"
